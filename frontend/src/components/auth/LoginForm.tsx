      ...
      <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        ...
        <div className="mt-4">
          ...
          <button
            ...
            disabled={loading}
            className="mt-3 w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 py-2 px-4 rounded-md hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
